...
// added for mobile
var list4 = document.getElementById("sidebar-ul-mobile");
var items4 = list4.getElementsByClassName("menu-item");
var count4 = items4.length - 2;
// alert("Count of Items4  is" + " " + (count4));
...
for (var i = 0; i < count1; i++) {
  ...
  // remove active from items4 list items
  for (n=0; n < count4; n++) {
    var element = items4[n];
      if (element.getElementsByClassName("active")) {
           element.className = element.className.replace(" active", "");
      }
   }  
...
//addEventListener for #sidebar-ul-mobile children
